<%@ Page Title="Perfumería" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="Perfumeria.aspx.cs" Inherits="PracticaProfesional2025.Perfumeria" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content" class="p-4 p-md-5 pt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="titulo-destacado">⚱️ PRODUCTOS DE PERFUMERÍA</h2>
