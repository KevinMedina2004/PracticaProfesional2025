...
namespace PracticaProfesional2025
{
    public partial class Postres : System.Web.UI.Page
    {
        ...
        protected void ImageButtonLEMONPIE_Click(object sender, ImageClickEventArgs e)
        {
        ...
        protected void TextBoxLEMONPIE_TextChanged(object sender, System.EventArgs e)
        {

        }

        protected void btnLEMONPIE_Click2(object sender, EventArgs e)
        {
            Button btn = (Button)sender;
            string producto = btn.CommandArgument;

            Control contenedor = btn.NamingContainer;
            TextBox TextBoxLEMONPIE = null;

            foreach (Control ctrl in contenedor.Controls)
            {
                if (ctrl is TextBox)
                {
                    TextBoxLEMONPIE = (TextBox)ctrl;
                    break;
                }
            }

            int cantidad = 1;
            if (TextBoxLEMONPIE != null)
            {
                int.TryParse(TextBoxLEMONPIE.Text, out cantidad);
            }
